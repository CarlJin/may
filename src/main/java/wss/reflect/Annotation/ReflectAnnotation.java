...
public class ReflectAnnotation {
    ...
    public static void print(FieldTypeAnnotation fieldAnno, String name) {
        //输出注解属性
        int age = fieldAnno.age();
        String[] hobby = fieldAnno.hobby();
        String type = fieldAnno.type();
        System.out.println(name + " age = " + age + ", hobby = " + Arrays.asList(hobby).toString() + " type = " + type);
    }
}
